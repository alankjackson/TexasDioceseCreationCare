...
Though really what I care most about is the grid, since that will yield the subsidence
values at each of the church locations
...
ggplot() +
  ...
  scale_fill_viridis_c(direction=-1, alpha=0.4, name="Subsidence Rate (cm/yr)") +
  #   Add a scale bar
