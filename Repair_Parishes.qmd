...
#   The Episcopal Church of Wichita Falls -> Faith Episcopal
#   What about St. Matthew's, Fort Worth
#   St Mary Magdalen Manor needs lat long
#   lat longs foe 152, 154, 159, 162, 
...
CasaMateo <- tribble(~ID, ~Label, ~City, ~Name, ~Description, ~Convocation, ~County, ~Address
                     ~geometry, ~Zip,
