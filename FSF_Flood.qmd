...
Flood_factor <- png::readPNG('flood-factor-matrix-2.png')
...
for (map_var in c("Fact3_grp", "Fact5_grp", "Fact8_grp")){
  ...
  Plot_title <- case_when(
    map_var == "Fact3_grp" ~ "Flood Factor 3 Flooding",
    map_var == "Fact5_grp" ~ "Flood Factor 5 Flooding",
    map_var == "Fact8_grp" ~ "Flood Factor 8 Flooding"
  )
  map_var <- ensym(map_var)
    # p <- 
      ...
      labs(title=Plot_title) 
        # ggimage::geom_image(aes(image=Flood_factor), size=0.2)
      # annotation_raster(Flood_factor, ymin=32.2, ymax=Inf, xmin=-96.2, xmax=Inf)
      # annotation_raster(Flood_factor, ymin=32.5, ymax=34.5, xmin=-96.5, xmax=-93.5)
